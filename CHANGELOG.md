...
- CLRP-000 through CLRP-009 (Draft)
- Documentation hierarchy: technical-reports, research-notes, validation, proposals, open-questions, bibliography, historical-influences
...
| Tag pattern | Meaning |
|-------------|---------|
| `clrp-vYYYY.M` | Programme release (e.g. `clrp-v2026.1`) |
| `CLRP-NNN-vX.Y.Z` | Individual accepted document release (optional, for major spec versions) |

Releases are cut when stewards determine a citable snapshot is needed (typically quarterly or after Accepted document batches).

---

## Document status changes

Status changes for individual CLRP documents are recorded in each document's revision history and summarised here at release time.
