# CLRP specification index

Canonical index of **CLRP-NNN** programme documents. For lifecycle rules see [docs/versioning/versioning-policy.md](../docs/versioning/versioning-policy.md).

## Core specifications (000–099)
...
| Range | Purpose |
|-------|---------|
| CLRP-000 – CLRP-099 | Core programme specifications |
| CLRP-100 – CLRP-199 | Domain extensions (e.g. cohort research, longitudinal standards) |
| CLRP-200+ | Special topics (assigned by steward) |
...
| Superseded | Replaced (see successor link) |
